...
export interface ProfileViewBasic {
    ...
    kind?: $Typed<DirectConvoMember> | $Typed<GroupConvoMember> | $Typed<PastGroupConvoMember> | {
        $type: string;
    };
}
...
export declare function isPastGroupConvoMember<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "chat.bsky.actor.defs", "pastGroupConvoMember">;
export declare function validatePastGroupConvoMember<V>(v: V): ValidationResult<PastGroupConvoMember & V>;
