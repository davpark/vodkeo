...
export function isDraftWithId(v) {
...
export function isDraftEmbedCaption(v) {
...
export function isDraftEmbedImage(v) {
...
export function isDraftEmbedVideo(v) {
...
export function isDraftEmbedExternal(v) {
...
export function isDraftEmbedRecord(v) {
