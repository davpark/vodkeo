...
export declare function isReportAssignment<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.report.defs", "reportAssignment">;
...
export declare function isReportView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.report.defs", "reportView">;
...
export declare function isQueueActivity<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.report.defs", "queueActivity">;
...
export declare function isAssignmentActivity<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.report.defs", "assignmentActivity">;
...
export declare function isEscalationActivity<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.report.defs", "escalationActivity">;
...
export declare function isCloseActivity<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.report.defs", "closeActivity">;
...
export declare function isReopenActivity<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.report.defs", "reopenActivity">;
...
export declare function isNoteActivity<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.report.defs", "noteActivity">;
...
export declare function isReportActivityView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.report.defs", "reportActivityView">;
...
export declare function isLiveStats<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.report.defs", "liveStats">;
...
export declare function isHistoricalStats<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.report.defs", "historicalStats">;
...
export declare function isAssignmentView<V>(v: V): v is import("../../../../util.js").$TypedObject<V, "tools.ozone.report.defs", "assignmentView">;
